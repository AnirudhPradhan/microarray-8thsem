...
public class GuiLauncher {
    public static Control buidGuiControl(ControlPanel control_panel, AdvancedPanel advanced_panel, String workspacePath, String experimentName) throws WrongContolException, InvalidImplementationException {
    ...
    public static void saveControl(ControlPanel control_panel, AdvancedPanel advanced_panel, String workspacePath, String experimentName, String destinationPath) throws WrongContolException, InvalidImplementationException, IOException {
        Properties guiProp = new Properties(SystemUtilities.getAlgorithmProperties());
        String auxOut = TextUtilities.appendToPath(workspacePath, experimentName);
        String auxDataset = control_panel.getDataset_combo();
        String auxN = control_panel.getN_value() + "";
