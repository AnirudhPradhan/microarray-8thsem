...
public final class RenderingUtils {
    ...
    public static void drawString(JComponent c2, Graphics g, String text, int x, int y) {
        if (drawStringMethod != null) {
            try {
                drawStringMethod.invoke(null, c2, g, text, x, y);
                return;
            }
    ...
    public static void drawStringUnderlineCharAt(JComponent c2, Graphics g, String text, int underlinedIndex, int x, int y) {
        if (drawStringUnderlineCharAtMethod != null) {
            try {
                drawStringUnderlineCharAtMethod.invoke(null, c2, g, text, new Integer(underlinedIndex), new Integer(x), new Integer(y));
                return;
            }
            catch (IllegalArgumentException e) {
            }
    ...
    public static FontMetrics getFontMetrics(JComponent c2, Graphics g) {
        if (getFontMetricsMethod != null) {
            try {
                return (FontMetrics)getFontMetricsMethod.invoke(null, c2, g);
            }
            catch (IllegalArgumentException e) {
            }
            catch (IllegalAccessException e) {
        ...
        return c2.getFontMetrics(g.getFont());
    }
