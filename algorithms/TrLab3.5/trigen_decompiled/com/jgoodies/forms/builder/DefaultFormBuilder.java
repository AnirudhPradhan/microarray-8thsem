...
extends I15dPanelBuilder {
    ...
    @Override
    public DefaultFormBuilder opaque(boolean b2) {
        super.opaque(b2);
        return this;
    }
    ...
    public JLabel append(String textWithMnemonic, Component c2, boolean nextLine) {
        JLabel label = this.append(textWithMnemonic, c2);
        if (nextLine) {
            this.nextLine();
        }
        return label;
    ...
    public JLabel append(String textWithMnemonic, Component c2, int columnSpan) {
        JLabel label = this.append(textWithMnemonic);
        label.setLabelFor(c2);
        this.append(c2, columnSpan);
        return label;
    }
    ...
    public JLabel appendI15d(String resourceKey, Component c2, int columnSpan) {
        return this.append(this.getResourceString(resourceKey), c2, columnSpan);
    }
