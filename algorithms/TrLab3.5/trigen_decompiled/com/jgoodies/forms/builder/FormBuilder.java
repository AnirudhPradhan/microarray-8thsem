...
public class FormBuilder {
    ...
    public FormBuilder honorsVisibility(boolean b2) {
        this.getLayout().setHonorsVisibility(b2);
        return this;
    }

    public FormBuilder honorsVisibility(JComponent c2, boolean b2) {
        this.getLayout().setHonorsVisibility(c2, b2);
        return this;
    }
    ...
    public FormBuilder debug(boolean b2) {
        this.debug = b2;
        return this;
    }
    ...
    public FormBuilder opaque(boolean b2) {
        this.getPanel().setOpaque(b2);
        return this;
    }
    ...
    public FormBuilder labelForFeatureEnabled(boolean b2) {
        this.labelForFeatureEnabled = b2;
        return this;
    }
    ...
    public ComponentAdder add(Component c2) {
        return this.add(true, c2);
    }

    public ComponentAdder addRaw(Component c2) {
        return this.addRaw(true, c2);
    }

    public ComponentAdder addScrolled(Component c2) {
        return this.addScrolled(true, c2);
    }
    ...
    public ComponentAdder add(boolean expression, Component c2) {
        if (!expression || c2 == null) {
            return new NoOpComponentAdder(this);
        }
        if (c2 instanceof JTable || c2 instanceof JList || c2 instanceof JTree) {
            return this.addScrolled(expression, c2);
        }
        return this.addRaw(expression, c2);
    }

    public ComponentAdder addRaw(boolean expression, Component c2) {
        if (!expression || c2 == null) {
            return new NoOpComponentAdder(this);
        }
        return this.addImpl(c2);
    }

    public ComponentAdder addScrolled(boolean expression, Component c2) {
        if (!expression || c2 == null) {
            return new NoOpComponentAdder(this);
        }
        return this.addImpl(new JScrollPane(c2));
    }
    ...
    protected ComponentAdder addImpl(Component c2) {
        if (this.getPanel().getLayout() == null) {
            this.panel.setLayout(this.getLayout());
        }
        return new ComponentAdder(this, c2);
    }
    ...
    private void manageLabelsAndComponents(Component c2) {
        ...
        if (mostRecentlyAddedLabel != null && FormBuilder.isLabelForApplicable(mostRecentlyAddedLabel, c2)) {
            FormBuilder.setLabelFor(mostRecentlyAddedLabel, c2);
            this.clearMostRecentlyAddedLabel();
        }
    }
    ...
    private static boolean isLabelForApplicable(JLabel label, Component component) {
        ...
        return c2.getClientProperty(LABELED_BY_PROPERTY) == null;
    }
    ...
    public static class ComponentAdder {
        ...
        public final ComponentAdder labelFor(Component c2) {
            ...
            ((JLabel)this.component).setLabelFor(c2);
