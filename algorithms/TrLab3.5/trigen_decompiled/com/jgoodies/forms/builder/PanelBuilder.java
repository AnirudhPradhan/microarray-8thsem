...
extends AbstractFormBuilder<PanelBuilder> {
    ...
    public PanelBuilder labelForFeatureEnabled(boolean b2) {
    ...
    private void manageLabelsAndComponents(Component c2) {
        ...
        if (mostRecentlyAddedLabel != null && this.isLabelForApplicable(mostRecentlyAddedLabel, c2)) {
            this.setLabelFor(mostRecentlyAddedLabel, c2);
            this.clearMostRecentlyAddedLabel();
        }
    }
