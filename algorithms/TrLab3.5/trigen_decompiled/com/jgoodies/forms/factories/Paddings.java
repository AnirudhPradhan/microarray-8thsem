...
public final class Paddings {
    ...
    extends EmptyBorder {
        ...
        public Insets getBorderInsets(Component c2, Insets insets) {
            insets.top = this.topMargin.getPixelSize(c2);
            insets.left = this.leftMargin.getPixelSize(c2);
            insets.bottom = this.bottomMargin.getPixelSize(c2);
            insets.right = this.rightMargin.getPixelSize(c2);
            return insets;
        }
    }
}
