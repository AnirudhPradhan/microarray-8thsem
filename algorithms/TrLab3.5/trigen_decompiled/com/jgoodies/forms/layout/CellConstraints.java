...
Serializable {
    ...
    void setBounds(Component c2, FormLayout layout, Rectangle cellBounds, FormLayout.Measure minWidthMeasure, FormLayout.Measure minHeightMeasure, FormLayout.Measure prefWidthMeasure, FormLayout.Measure prefHeightMeasure) {
        ...
        int compW = CellConstraints.componentSize(c2, colSpec, cellW, minWidthMeasure, prefWidthMeasure);
        int compH = CellConstraints.componentSize(c2, rowSpec, cellH, minHeightMeasure, prefHeightMeasure);
    ...
    public Object clone() {
        try {
            CellConstraints c2 = (CellConstraints)super.clone();
            c2.insets = (Insets)this.insets.clone();
            return c2;
        }
