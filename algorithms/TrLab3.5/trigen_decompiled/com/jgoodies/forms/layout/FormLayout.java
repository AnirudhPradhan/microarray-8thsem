...
Serializable {
    ...
    public void setHonorsVisibility(boolean b2) {
        boolean oldHonorsVisibility = this.getHonorsVisibility();
        if (oldHonorsVisibility == b2) {
            return;
        }
        this.honorsVisibility = b2;
    ...
    public void setHonorsVisibility(Component component, Boolean b2) {
        CellConstraints constraints = this.getConstraints0(component);
        if (Objects.equals(b2, constraints.honorsVisibility)) {
            return;
        }
        constraints.honorsVisibility = b2;
    ...
    extends CachingMeasure {
        ...
        @Override
        public int sizeOf(Component c2) {
            return this.cache.getPreferredSize((Component)c2).height;
        }
    }
    ...
    extends CachingMeasure {
        ...
        @Override
        public int sizeOf(Component c2) {
            return this.cache.getPreferredSize((Component)c2).width;
        }
    }
    ...
    extends CachingMeasure {
        ...
        @Override
        public int sizeOf(Component c2) {
            return this.cache.getMinimumSize((Component)c2).height;
        }
    }
    ...
    extends CachingMeasure {
        ...
        @Override
        public int sizeOf(Component c2) {
            return this.cache.getMinimumSize((Component)c2).width;
        }
    }
