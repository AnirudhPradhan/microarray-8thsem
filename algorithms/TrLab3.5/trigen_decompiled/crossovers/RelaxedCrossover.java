...
public class RelaxedCrossover
implements Crossover {
    private CrossoverStrategy relajado = new RelaxedStrategy();
    ...
    public List<AlgorithmIndividual> cross(int numberOfChildren, List<AlgorithmIndividual> selectedPopulation) {
        ...
        for (int i = 0; i < numberOfChildren; ++i) {
            ...
            AlgorithmIndividual[] hijos = this.relajado.cross(padre, madre, trigen.getIndividualClassName());
            r.add(hijos[0]);
        }
        return r;
    }
