...
public class TimeSeriesInitialPop
implements InitialPop {
    private InitialPopStrategy aleatoria = new RandomTimeSeriesStrategy();
    private InitialPopStrategy jerarquica = new HierarchycalTimeSeriesStrategy();
