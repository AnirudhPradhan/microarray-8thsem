...
public class LabOneSolRun
extends SolLoadWorkFlow {
    @Override
    public AnalysisResources loadSolution(String pathToSol) throws FileNotFoundException, IOException, WrongContolException, InvalidImplementationException {
