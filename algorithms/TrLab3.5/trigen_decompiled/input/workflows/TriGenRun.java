...
public class TriGenRun
implements AlgorithmWorkFlow {
    private static final Logger LOG = LoggerFactory.getLogger(TriGenRun.class);

    @Override
    public Control loadControl(String pathToControl) throws FileNotFoundException, IOException, WrongContolException, InvalidImplementationException {
