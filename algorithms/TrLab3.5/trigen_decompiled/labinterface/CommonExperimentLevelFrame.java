...
import labinterface.CommonExpTableModel;
...
public class CommonExperimentLevelFrame
extends JFrame {
    ...
    private void buildSummaryGraphs() {
        ...
        triqTable.addMouseListener(new MouseAdapter(){
            ...
            public void mousePressed(MouseEvent me) {
                ...
                if (me.getClickCount() == 2) {
                    CommonExperimentLevelFrame.this.solutionLevelFrame.displaySolution(index);
                }
            }
        });
        ...
        solLevelButton.addActionListener(new ActionListener(){
            ...
            public void actionPerformed(ActionEvent e) {
                CommonExperimentLevelFrame.this.solutionLevelFrame.setVisible(true);
            }
        });
        ...
        this.contentPane.add((Component)tScroll, "span 2 3,align left");
