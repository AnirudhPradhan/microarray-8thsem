...
extends BaseRuleFactory<BigDecimal> {
    ...
    protected Pair<BigDecimal[], BigDecimal[]> computeRule(int numberOfPoints) throws DimensionMismatchException {
        ...
        for (int i = 0; i < iMax; ++i) {
            BigDecimal tmp2;
            BigDecimal tmp1;
            BigDecimal a2 = i == 0 ? this.minusOne : previousPoints[i - 1];
            BigDecimal b2 = iMax == 1 ? BigDecimal.ONE : previousPoints[i];
            ...
            BigDecimal tmp12 = pmc.subtract(c2.multiply(pc, this.mContext), this.mContext);
