...
Serializable {
    ...
    public boolean equals(Object other) {
        ...
        if (other instanceof Complex) {
            Complex c2 = (Complex)other;
            if (c2.isNaN) {
                return this.isNaN;
            }
            return MathUtils.equals(this.real, c2.real) && MathUtils.equals(this.imaginary, c2.imaginary);
        }
        return false;
    }
