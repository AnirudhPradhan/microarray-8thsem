...
public class ComplexFormat {
    ...
    public String format(Complex c2) {
        return this.format(c2, new StringBuffer(), new FieldPosition(0)).toString();
    }

    public String format(Double c2) {
        return this.format(new Complex(c2, 0.0), new StringBuffer(), new FieldPosition(0)).toString();
    }
