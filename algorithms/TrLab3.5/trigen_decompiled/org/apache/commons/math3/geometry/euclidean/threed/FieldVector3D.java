...
implements Serializable {
    ...
    public FieldVector3D(T a2, FieldVector3D<T> u) {
        this.x = (RealFieldElement)a2.multiply(u.x);
        this.y = (RealFieldElement)a2.multiply(u.y);
        this.z = (RealFieldElement)a2.multiply(u.z);
    }

    public FieldVector3D(T a2, Vector3D u) {
        this.x = (RealFieldElement)a2.multiply(u.getX());
        this.y = (RealFieldElement)a2.multiply(u.getY());
        this.z = (RealFieldElement)a2.multiply(u.getZ());
    }

    public FieldVector3D(double a2, FieldVector3D<T> u) {
        this.x = (RealFieldElement)u.x.multiply(a2);
        this.y = (RealFieldElement)u.y.multiply(a2);
        this.z = (RealFieldElement)u.z.multiply(a2);
    }
    ...
    public FieldVector3D<T> scalarMultiply(T a2) {
        return new FieldVector3D<RealFieldElement>((RealFieldElement)this.x.multiply(a2), (RealFieldElement)this.y.multiply(a2), (RealFieldElement)this.z.multiply(a2));
    }
