...
implements Embedding<Euclidean3D, Euclidean1D> {
    ...
    public Vector3D closestPoint(Line line) {
        ...
        double a2 = ((Vector3D)delta0).dotProduct(this.direction);
        double b2 = ((Vector3D)delta0).dotProduct(line.direction);
        return new Vector3D(1.0, this.zero, (a2 - b2 * cos) / n, this.direction);
    }
