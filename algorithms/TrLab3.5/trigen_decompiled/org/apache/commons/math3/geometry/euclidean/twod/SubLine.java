...
extends AbstractSubHyperplane<Euclidean2D, Euclidean1D> {
    ...
    public Side side(Hyperplane<Euclidean2D> hyperplane) {
        ...
        Vector2D crossing = thisLine.intersection(otherLine = (Line)hyperplane);
        if (crossing == null) {
        ...
        return this.getRemainingRegion().side(new OrientedPoint((Vector1D)x, direct, thisLine.getTolerance()));
    }
