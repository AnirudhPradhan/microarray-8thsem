...
extends PreconditionedIterativeLinearSolver {
    ...
    public RealVector solveInPlace(RealLinearOperator a2, RealLinearOperator m, RealVector b2, RealVector x0) throws NullArgumentException, NonPositiveDefiniteOperatorException, NonSquareOperatorException, DimensionMismatchException, MaxCountExceededException {
        ConjugateGradient.checkParameters(a2, m, b2, x0);
        ...
        RealVector p = x.copy();
        RealVector q = a2.operate(p);
        RealVector r = b2.combine(1.0, -1.0, q);
