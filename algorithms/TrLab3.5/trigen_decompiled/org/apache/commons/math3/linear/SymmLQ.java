...
extends PreconditionedIterativeLinearSolver {
    ...
    public RealVector solve(RealLinearOperator a2, RealLinearOperator m, RealVector b2) throws NullArgumentException, NonSquareOperatorException, DimensionMismatchException, MaxCountExceededException, NonSelfAdjointOperatorException, NonPositiveDefiniteOperatorException, IllConditionedOperatorException {
        MathUtils.checkNotNull(a2);
        ArrayRealVector x = new ArrayRealVector(a2.getColumnDimension());
        return this.solveInPlace(a2, m, b2, x, false, 0.0);
    }

    public RealVector solve(RealLinearOperator a2, RealLinearOperator m, RealVector b2, boolean goodb, double shift) throws NullArgumentException, NonSquareOperatorException, DimensionMismatchException, MaxCountExceededException, NonSelfAdjointOperatorException, NonPositiveDefiniteOperatorException, IllConditionedOperatorException {
        MathUtils.checkNotNull(a2);
        ArrayRealVector x = new ArrayRealVector(a2.getColumnDimension());
        return this.solveInPlace(a2, m, b2, x, goodb, shift);
    }

    public RealVector solve(RealLinearOperator a2, RealLinearOperator m, RealVector b2, RealVector x) throws NullArgumentException, NonSquareOperatorException, DimensionMismatchException, NonSelfAdjointOperatorException, NonPositiveDefiniteOperatorException, IllConditionedOperatorException, MaxCountExceededException {
        MathUtils.checkNotNull(x);
        return this.solveInPlace(a2, m, b2, x.copy(), false, 0.0);
    }
    ...
    public RealVector solve(RealLinearOperator a2, RealVector b2) throws NullArgumentException, NonSquareOperatorException, DimensionMismatchException, NonSelfAdjointOperatorException, IllConditionedOperatorException, MaxCountExceededException {
        ...
        return this.solveInPlace(a2, null, b2, x, false, 0.0);
    }
    ...
    public RealVector solve(RealLinearOperator a2, RealVector b2, boolean goodb, double shift) throws NullArgumentException, NonSquareOperatorException, DimensionMismatchException, NonSelfAdjointOperatorException, IllConditionedOperatorException, MaxCountExceededException {
        MathUtils.checkNotNull(a2);
        ArrayRealVector x = new ArrayRealVector(a2.getColumnDimension());
        return this.solveInPlace(a2, null, b2, x, goodb, shift);
    }

    public RealVector solve(RealLinearOperator a2, RealVector b2, RealVector x) throws NullArgumentException, NonSquareOperatorException, DimensionMismatchException, NonSelfAdjointOperatorException, IllConditionedOperatorException, MaxCountExceededException {
        MathUtils.checkNotNull(x);
        return this.solveInPlace(a2, null, b2, x.copy(), false, 0.0);
    }

    public RealVector solveInPlace(RealLinearOperator a2, RealLinearOperator m, RealVector b2, RealVector x) throws NullArgumentException, NonSquareOperatorException, DimensionMismatchException, NonSelfAdjointOperatorException, NonPositiveDefiniteOperatorException, IllConditionedOperatorException, MaxCountExceededException {
        return this.solveInPlace(a2, m, b2, x, false, 0.0);
    }

    public RealVector solveInPlace(RealLinearOperator a2, RealLinearOperator m, RealVector b2, RealVector x, boolean goodb, double shift) throws NullArgumentException, NonSquareOperatorException, DimensionMismatchException, NonSelfAdjointOperatorException, NonPositiveDefiniteOperatorException, IllConditionedOperatorException, MaxCountExceededException {
        SymmLQ.checkParameters(a2, m, b2, x);
        IterationManager manager = this.getIterationManager();
        manager.resetIterationCount();
        manager.incrementIterationCount();
        State state = new State(a2, m, b2, goodb, shift, this.delta, this.check);
        state.init();
        state.refineSolution(x);
        DefaultIterativeLinearSolverEvent event = new DefaultIterativeLinearSolverEvent(this, manager.getIterations(), x, b2, state.getNormOfResidual());
        ...
        if (!earlyStop) {
            do {
                manager.incrementIterationCount();
                event = new DefaultIterativeLinearSolverEvent(this, manager.getIterations(), x, b2, state.getNormOfResidual());
    ...
    public RealVector solveInPlace(RealLinearOperator a2, RealVector b2, RealVector x) throws NullArgumentException, NonSquareOperatorException, DimensionMismatchException, NonSelfAdjointOperatorException, IllConditionedOperatorException, MaxCountExceededException {
        return this.solveInPlace(a2, null, b2, x, false, 0.0);
    }
    ...
    private static class State {
        ...
        public State(RealLinearOperator a2, RealLinearOperator m, RealVector b2, boolean goodb, double shift, double delta, boolean check) {
            this.a = a2;
            this.m = m;
            this.b = b2;
            ...
            this.goodb = goodb;
            this.shift = shift;
            this.mb = m == null ? b2 : m.operate(b2);
        ...
        private static void daxpy(double a2, RealVector x, RealVector y) {
            int n = x.getDimension();
            for (int i = 0; i < n; ++i) {
                y.setEntry(i, a2 * x.getEntry(i) + y.getEntry(i));
            }
        }

        private static void daxpbypz(double a2, RealVector x, double b2, RealVector y, RealVector z) {
            int n = z.getDimension();
            for (int i = 0; i < n; ++i) {
                double zi = a2 * x.getEntry(i) + b2 * y.getEntry(i) + z.getEntry(i);
                z.setEntry(i, zi);
            }
        }
        ...
        void update() {
            ...
            double deltak = c2 * this.dbar + s * alpha;
            this.gbar = s * this.dbar - c2 * alpha;
            ...
            for (int i = 0; i < n; ++i) {
                ...
                this.wbar.setEntry(i, wi * s - vi * c2);
            }
