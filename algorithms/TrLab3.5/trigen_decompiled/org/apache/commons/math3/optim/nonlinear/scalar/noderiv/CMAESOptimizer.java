...
extends MultivariateOptimizer {
    ...
    private static RealMatrix log(RealMatrix m) {
        ...
        for (int r = 0; r < m.getRowDimension(); ++r) {
            for (int c2 = 0; c2 < m.getColumnDimension(); ++c2) {
                d[r][c2] = FastMath.log(m.getEntry(r, c2));
            }
        }
    ...
    private static RealMatrix sqrt(RealMatrix m) {
        ...
        for (int r = 0; r < m.getRowDimension(); ++r) {
            for (int c2 = 0; c2 < m.getColumnDimension(); ++c2) {
                d[r][c2] = FastMath.sqrt(m.getEntry(r, c2));
            }
        }
        return new Array2DRowRealMatrix(d, false);
    }
    ...
    private static RealMatrix times(RealMatrix m, RealMatrix n) {
        ...
        for (int r = 0; r < m.getRowDimension(); ++r) {
            for (int c2 = 0; c2 < m.getColumnDimension(); ++c2) {
                d[r][c2] = m.getEntry(r, c2) * n.getEntry(r, c2);
            }
        }
        return new Array2DRowRealMatrix(d, false);
    }
    ...
    private static RealMatrix triu(RealMatrix m, int k) {
        ...
        for (int r = 0; r < m.getRowDimension(); ++r) {
            for (int c2 = 0; c2 < m.getColumnDimension(); ++c2) {
                d[r][c2] = r <= c2 - k ? m.getEntry(r, c2) : 0.0;
            }
        }
        return new Array2DRowRealMatrix(d, false);
    }
    ...
    private static RealMatrix repmat(RealMatrix mat, int n, int m) {
        ...
        for (int r = 0; r < n * rd; ++r) {
            for (int c2 = 0; c2 < m * cd; ++c2) {
                d[r][c2] = mat.getEntry(r % rd, c2 % cd);
            }
        }
        return new Array2DRowRealMatrix(d, false);
    }
    ...
    private RealMatrix randn1(int size, int popSize) {
        ...
        for (int r = 0; r < size; ++r) {
            for (int c2 = 0; c2 < popSize; ++c2) {
                d[r][c2] = this.random.nextGaussian();
            }
        }
        return new Array2DRowRealMatrix(d, false);
    }
