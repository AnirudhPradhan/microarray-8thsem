...
Serializable {
    ...
    @Override
    public Object[] nextSample(Collection<?> c2, int k) throws NumberIsTooLargeException, NotStrictlyPositiveException {
        int len = c2.size();
        if (k > len) {
