...
implements RandomVectorGenerator {
            ...
            while ((line = reader.readLine()) != null) {
                ...
                try {
                    ...
                    if (dim >= 2 && dim <= this.dimension) {
                        ...
                        this.initDirectionVector(index++, a2, m);
                    }
    ...
    private void initDirectionVector(int d, int a2, int[] m) {
        int i;
        int s = m.length - 1;
        for (i = 1; i <= s; ++i) {
        ...
        for (i = s + 1; i <= 52; ++i) {
            ...
            for (int k = 1; k <= s - 1; ++k) {
                ...
                int n = i;
                lArray[n] = lArray[n] ^ (long)(a2 >> s - 1 - k & 1) * this.direction[d][i - k];
            }
        }
    }
    ...
    public double[] nextVector() {
        ...
        for (int i = 0; i < this.dimension; ++i) {
            int n = i;
            this.x[n] = this.x[n] ^ this.direction[i][c2];
