...
Serializable {
    ...
    public BigReal add(BigReal a2) {
        return new BigReal(this.d.add(a2.d));
    }

    @Override
    public BigReal subtract(BigReal a2) {
        return new BigReal(this.d.subtract(a2.d));
    }
    ...
    public BigReal divide(BigReal a2) throws MathArithmeticException {
        try {
            return new BigReal(this.d.divide(a2.d, this.scale, this.roundingMode));
        }
    ...
    public BigReal multiply(BigReal a2) {
        return new BigReal(this.d.multiply(a2.d));
    }
