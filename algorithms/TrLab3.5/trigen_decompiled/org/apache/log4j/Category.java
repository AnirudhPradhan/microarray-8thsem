...
implements AppenderAttachable {
    ...
    public void callAppenders(LoggingEvent event) {
        ...
        while (c2 != null) {
            ...
            synchronized (category) {
                if (c2.aai != null) {
                    writes += c2.aai.appendLoopOnAppenders(event);
                }
                if (!c2.additive) {
                    break;
                }
    ...
    synchronized void closeNestedAppenders() {
        ...
        if (enumeration != null) {
            while (enumeration.hasMoreElements()) {
                Appender a2 = (Appender)enumeration.nextElement();
                if (!(a2 instanceof AppenderAttachable)) continue;
                a2.close();
            }
        }
    }
    ...
    public ResourceBundle getResourceBundle() {
        Category c2 = this;
        while (c2 != null) {
            if (c2.resourceBundle != null) {
                return c2.resourceBundle;
            }
            c2 = c2.parent;
        }
        return null;
