...
public class RendererMap {
    ...
    public ObjectRenderer get(Class clazz) {
        ...
        for (Class c2 = clazz; c2 != null; c2 = c2.getSuperclass()) {
            r = (ObjectRenderer)this.map.get(c2);
            if (r != null) {
                return r;
            }
            r = this.searchInterfaces(c2);
            if (r == null) continue;
            return r;
        }
    ...
    ObjectRenderer searchInterfaces(Class c2) {
        ObjectRenderer r = (ObjectRenderer)this.map.get(c2);
        if (r != null) {
            return r;
        }
        Class<?>[] ia = c2.getInterfaces();
