...
public final class PatternParser {
        ...
        while (i < patternLength) {
            ...
            block0 : switch (state) {
                ...
                case 1: {
                    ...
                    i = PatternParser.finalizeConverter(c2, pattern, i, currentLiteral, formattingInfo, converterRegistry, rules, patternConverters, formattingInfos);
                    state = 0;
                    formattingInfo = FormattingInfo.getDefault();
                    currentLiteral.setLength(0);
                    break;
    ...
    private static int finalizeConverter(char c2, String pattern, int i, StringBuffer currentLiteral, FormattingInfo formattingInfo, Map converterRegistry, Map rules, List patternConverters, List formattingInfos) {
        StringBuffer convBuf = new StringBuffer();
        i = PatternParser.extractConverter(c2, pattern, i, convBuf, currentLiteral);
