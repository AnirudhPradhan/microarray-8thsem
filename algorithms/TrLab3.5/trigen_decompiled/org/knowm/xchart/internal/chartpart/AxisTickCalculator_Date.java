...
public class AxisTickCalculator_Date
extends AxisTickCalculator_ {
    ...
    private void calculate() {
        ...
        do {
            ...
            for (double value = firstPosition; value <= this.maxValue + 2.0 * gridStep; value += gridStep) {
                this.tickLabels.add(simpleDateformat.format(value));
                double tickLabelPosition = margin + (value - this.minValue) / (this.maxValue - this.minValue) * tickSpace;
